			...
			_library = new Dictionary<EntityRequestType, Func<Endpoint>>
				{
					...
					{EntityRequestType.Board_Write_AddLabel, () => new Endpoint(RestMethod.Post, new[]{"boards", "_id", "labels"})},
					...
					{EntityRequestType.Label_Read_Refresh, () => new Endpoint(RestMethod.Get, new[]{"boards","_boardId", "labels","_id"})},
					{EntityRequestType.Label_Write_Update, () => new Endpoint(RestMethod.Put, new[]{"boards","_boardId", "labels", "_id"})},
