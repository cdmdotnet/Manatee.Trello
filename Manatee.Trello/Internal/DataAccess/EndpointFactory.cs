			...
			_library = new Dictionary<EntityRequestType, Func<Endpoint>>
				{
					...
					{EntityRequestType.Board_Read_CardsForMember, () => new Endpoint(RestMethod.Get, new[]{"boards","_id","members","_idMember","cards"})},
					{EntityRequestType.Board_Read_Labels, () => new Endpoint(RestMethod.Get, new[]{"boards","_id","labels"})},
					...
					{EntityRequestType.Board_Read_PersonalPrefs, () => new Endpoint(RestMethod.Get, new[]{"boards","_id","myPrefs"})},
					{EntityRequestType.Board_Read_Refresh, () => new Endpoint(RestMethod.Get, new[]{"boards","_id"})},
					{EntityRequestType.Board_Write_AddLabel, () => new Endpoint(RestMethod.Post, new[]{"labels"})},
					...
					{EntityRequestType.Board_Write_PersonalPrefs, () => new Endpoint(RestMethod.Put, new[]{"boards","_id","myPrefs"})},
					{EntityRequestType.Board_Write_RemoveLabel, () => new Endpoint(RestMethod.Delete, new[]{"boards","_id","labels","_labelId"})},
					...
					{EntityRequestType.Card_Read_Stickers, () => new Endpoint(RestMethod.Get, new[]{"cards","_id","stickers"})},
					...
					{EntityRequestType.Card_Write_AddLabel, () => new Endpoint(RestMethod.Post, new[]{"cards","_id","idLabels"})},
					{EntityRequestType.Card_Write_AddSticker, () => new Endpoint(RestMethod.Post, new[]{"cards","_id","stickers"})},
					...
					{EntityRequestType.Card_Write_RemoveLabel, () => new Endpoint(RestMethod.Delete, new[]{"cards","_id","idlabels","_labelId"})},
					...
					{EntityRequestType.Label_Read_Refresh, () => new Endpoint(RestMethod.Get, new[]{"labels","_id"})},
					{EntityRequestType.Label_Write_Delete, () => new Endpoint(RestMethod.Delete, new[]{"labels", "_id"})},
					{EntityRequestType.Label_Write_Update, () => new Endpoint(RestMethod.Put, new[]{"labels", "_id"})},
					...
					{EntityRequestType.Notification_Write_Update, () => new Endpoint(RestMethod.Put, new[]{"notifications","_id"})},
					...
					{EntityRequestType.Sticker_Write_Delete, () => new Endpoint(RestMethod.Delete, new[]{"cards","_cardId","stickers","_id"})},
					{EntityRequestType.Sticker_Write_Update, () => new Endpoint(RestMethod.Put, new[]{"cards","_cardId","stickers","_id"})},
