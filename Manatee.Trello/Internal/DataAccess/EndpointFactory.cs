			...
			_library = new Dictionary<EntityRequestType, Func<Endpoint>>
				{
					...
					{EntityRequestType.CustomField_Read_Refresh, () => new Endpoint(RestMethod.Get, "customFields", "_id")},
					{EntityRequestType.CustomField_Write_Delete, () => new Endpoint(RestMethod.Delete, "customFields", "_id")},
					{EntityRequestType.CustomField_Write_Update, () => new Endpoint(RestMethod.Put, "customFields", "_id")},
