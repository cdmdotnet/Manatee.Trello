			...
			_library = new Dictionary<EntityRequestType, Func<Endpoint>>
				{
					...
					{EntityRequestType.Board_Write_DisablePowerUp, () => new Endpoint(RestMethod.Delete, "boards", "_boardId", "boardPlugins", "_id")},
					{EntityRequestType.Board_Write_Delete, () => new Endpoint(RestMethod.Delete, "boards", "_id")},
					{EntityRequestType.Board_Write_EnablePowerUp, () => new Endpoint(RestMethod.Post, "boards", "_id", "boardPlugins")},
					...
					{EntityRequestType.CommentReaction_Write_Delete, () => new Endpoint(RestMethod.Get, "actions", "_actionId", "reactions", "_id")},
					...
					{EntityRequestType.CustomFieldDefinition_Write_AddOption, () => new Endpoint(RestMethod.Post, "customFields", "_id", "options")},
					...
					{EntityRequestType.StarredBoard_Read_Refresh, () => new Endpoint(RestMethod.Get, "members", "_memberId", "boardStars", "_id")},
					{EntityRequestType.StarredBoard_Write_Delete, () => new Endpoint(RestMethod.Delete, "members", "_memberId", "boardStars", "_id")},
					{EntityRequestType.StarredBoard_Write_Update, () => new Endpoint(RestMethod.Put, "members", "_memberId", "boardStars", "_id")},
