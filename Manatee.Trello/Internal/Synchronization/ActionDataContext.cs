	...
	internal class ActionDataContext : LinkedSynchronizationContext<IJsonActionData>
	{
		static ActionDataContext()
		{
			_properties = new Dictionary<string, Property<IJsonActionData>>
				{
					{
						"Attachment", new Property<IJsonActionData, Attachment>((d, a) => d.Attachment == null ? null : new Attachment(d.Attachment, d.Card.Id, a),
						                                                        (d, o) => { if (o != null) d.Attachment = o.Json; })
					},
					{
						"Board", new Property<IJsonActionData, Board>((d, a) => d.Board == null ? null : new Board(d.Board, a),
						                                              (d, o) => { if (o != null) d.Board = o.Json; })
					},
					{
						"BoardSource", new Property<IJsonActionData, Board>((d, a) => d.BoardSource == null ? null : new Board(d.BoardSource, a),
						                                                    (d, o) => { if (o != null) d.BoardSource = o.Json; })
					},
					{
						"BoardTarget", new Property<IJsonActionData, Board>((d, a) => d.BoardTarget == null ? null : new Board(d.BoardTarget, a),
						                                                    (d, o) => { if (o != null) d.BoardTarget = o.Json; })
					},
					{
						"Card", new Property<IJsonActionData, Card>((d, a) => d.Card == null ? null : new Card(d.Card, a),
						                                            (d, o) => { if (o != null) d.Card = o.Json; })
					},
					{
						"CardSource", new Property<IJsonActionData, Card>((d, a) => d.CardSource == null ? null : new Card(d.CardSource, a),
						                                                  (d, o) => { if (o != null) d.CardSource = o.Json; })
					},
					{
						"CheckItem", new Property<IJsonActionData, CheckItem>((d, a) => d.CheckItem == null || d.CheckList == null ? null : new CheckItem(d.CheckItem, d.CheckList.Id),
					...
					{
						"ListAfter", new Property<IJsonActionData, List>((d, a) => d.ListAfter == null ? null : new List(d.ListAfter, a),
						                                                 (d, o) => { if (o != null) d.ListAfter = o.Json; })
					},
					{
						"ListBefore", new Property<IJsonActionData, List>((d, a) => d.ListBefore == null ? null : new List(d.ListBefore, a),
					...
					{
						"OldList", new Property<IJsonActionData, List>((d, a) => d.Old?.List == null ? null : new List(d.Old.List, a),
					...
					{
						"Organization", new Property<IJsonActionData, Organization>((d, a) => d.Org == null ? null : new Organization(d.Org, a),
																					(d, o) => { if (o != null) d.Org = o.Json; })
					},
					{"PowerUp", new Property<IJsonActionData, PowerUpBase>((d, a) => (PowerUpBase) d.Plugin?.GetFromCache<IPowerUp>(a),
																		   (d, o) => { if (o != null) d.Plugin = o.Json; }) },
