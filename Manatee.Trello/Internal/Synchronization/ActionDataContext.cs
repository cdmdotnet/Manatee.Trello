			...
			Properties = new Dictionary<string, Property<IJsonActionData>>
				{
					...
					},
					{
						...
						new Property<IJsonActionData, Board>((d, a) => d.Board?.GetFromCache<Board, IJsonBoard>(a),
						                                     (d, o) =>
							                                     {
					...
					},
					{
						...
						new Property<IJsonActionData, Board>((d, a) => d.BoardSource?.GetFromCache<Board, IJsonBoard>(a),
						                                     (d, o) =>
							                                     {
					...
					},
					{
						...
						new Property<IJsonActionData, Board>((d, a) => d.BoardTarget?.GetFromCache<Board, IJsonBoard>(a),
						                                     (d, o) =>
							                                     {
					...
					},
					{
						...
						new Property<IJsonActionData, Card>((d, a) => d.Card?.GetFromCache<Card, IJsonCard>(a),
						                                    (d, o) =>
							                                    {
					...
					},
					{
						...
						new Property<IJsonActionData, Card>((d, a) => d.CardSource?.GetFromCache<Card, IJsonCard>(a),
						                                    (d, o) =>
							                                    {
					...
					},
					{
						...
						new Property<IJsonActionData, CheckList>((d, a) => d.CheckList.GetFromCache<CheckList, IJsonCheckList>(a),
						                                         (d, o) =>
							                                         {
					...
					},
					{
						...
						new Property<IJsonActionData, Label>((d, a) => d.Label?.GetFromCache<Label, IJsonLabel>(a),
						                                     (d, o) =>
							                                     {
					...
					},
					{
						...
						new Property<IJsonActionData, List>((d, a) => d.List?.GetFromCache<List, IJsonList>(a),
						                                    (d, o) =>
							                                    {
					...
					},
					{
						...
						new Property<IJsonActionData, List>((d, a) => d.ListAfter?.GetFromCache<List, IJsonList>(a),
						                                    (d, o) =>
							                                    {
					...
					},
					{
						...
						new Property<IJsonActionData, List>((d, a) => d.ListBefore?.GetFromCache<List, IJsonList>(a),
						                                    (d, o) =>
							                                    {
					...
					},
					{
						...
						new Property<IJsonActionData, Member>((d, a) => d.Member?.GetFromCache<Member, IJsonMember>(a),
						                                      (d, o) =>
							                                      {
					...
					},
					{
						...
						new Property<IJsonActionData, List>((d, a) => d.Old?.List?.GetFromCache<List, IJsonList>(a),
						                                    (d, o) =>
							                                    {
