			...
			_library = new Dictionary<EntityRequestType, Func<Endpoint>>
				{
					...
					{EntityRequestType.Card_Read_CheckItems, () => new Endpoint(RestMethod.Get, new[]{"checklists","_id","checkItems"})},
					...
					{EntityRequestType.CheckItem_Write_Name, () => new Endpoint(RestMethod.Put, new[]{"cards","_cardId","checklists","_checkListId","checkItems","_id","name"})},
					{EntityRequestType.CheckItem_Write_Position, () => new Endpoint(RestMethod.Put, new[]{"cards","_cardId","checklists","_checkListId","checkItems","_id","pos"})},
					{EntityRequestType.CheckItem_Read_Refresh, () => new Endpoint(RestMethod.Get, new[]{"checklists","_checkListId","checkItems","_id"})},
					{EntityRequestType.CheckItem_Write_State, () => new Endpoint(RestMethod.Put, new[]{"cards","_cardId","checklists","_checkListId","checkItems","_id","state"})},
					...
					{EntityRequestType.Member_Write_CreateOrganizations, () => new Endpoint(RestMethod.Post, new[]{"organizations"})},
					...
					{EntityRequestType.Member_Read_Organization, () => new Endpoint(RestMethod.Get, new[]{"members","_id","organizations"})},
