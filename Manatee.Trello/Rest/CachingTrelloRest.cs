/***************************************************************************************
	...
	File Name:		CachingTrelloRest.cs
	Namespace:		Manatee.Trello.Rest
	Class Name:		CachingTrelloRest
	Purpose:		Extends an implementation of ITrelloRest to add caching.
...
namespace Manatee.Trello.Rest
{
	...
	{
		private readonly ITrelloRest _inner;
		...
		public string AuthToken { get { return _inner.AuthToken; } set { _inner.AuthToken = value; } }
