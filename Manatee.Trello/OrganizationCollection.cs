...
namespace Manatee.Trello
{
	...
	public class ReadOnlyOrganizationCollection : ReadOnlyCollection<Organization>
	{
		...
		public ReadOnlyOrganizationCollection(ReadOnlyOrganizationCollection doNotUse)
		...
		/// </remarks>
		public virtual Organization this[string key] => GetByKey(key);
	...
	{
		[Obsolete("This constructor is only for mocking purposes.")]
		public OrganizationCollection(OrganizationCollection doNotUse)
			: base(doNotUse)
		{
		}
		...
		public virtual Organization Add(string displayName)
		{
