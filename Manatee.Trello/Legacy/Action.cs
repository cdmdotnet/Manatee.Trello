...
namespace Manatee.Trello
{
	...
	public class Action : ExpiringObject, IEquatable<Action>, IComparable<Action>
	{
		...
		public override string ToString()
		{
			...
			TrelloServiceConfiguration.Log.Info("I don't have action type '{0}' configured yet.  If you can, please find the log entry where " +
		...
		internal override bool EqualsJson(object obj)
		{
			...
			return (json != null) && (json.Id == _jsonAction.Id);
		}
