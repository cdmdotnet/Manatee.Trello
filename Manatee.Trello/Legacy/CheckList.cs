...
namespace Manatee.Trello
{
	...
	public class CheckList : ExpiringObject, IEquatable<CheckList>, IComparable<CheckList>, ICanWebhook
	{
		...
		public CheckItem AddCheckItem(string name, CheckItemState state = CheckItemState.Incomplete, Position position = null)
		{
			if (_isDeleted) return null;
			Validator.Writable();
			...
			Parameters.Add("checked", (state == CheckItemState.Complete).ToLowerString());
