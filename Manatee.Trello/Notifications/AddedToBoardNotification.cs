...
{
	/// <summary>
	/// Provides notification that the current member was added to a board.
	/// </summary>
	public class AddedToBoardNotification : Notification
	{
		...
		/// <summary>
		/// Creates a new instance of the AddedToBoardNotification class.
		/// </summary>
		/// <param name="notification">The base notification</param>
		public AddedToBoardNotification(Notification notification)
		...
		{
			return _stringFormat ?? (_stringFormat = string.Format("{0} added you to board '{1}'.",
