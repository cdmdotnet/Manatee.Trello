/***************************************************************************************
	...
	File Name:		AddedToCardNotification.cs
	Namespace:		Manatee.Trello
	Class Name:		AddedToCardNotification
...
{
	/// <summary>
	/// Provides notification that the current member was added to a card.
	/// </summary>
	public class AddedToCardNotification : Notification
	{
		...
		/// <summary>
		/// Creates a new instance of the AddedToCardNotification class.
		/// </summary>
		...
		{
			return _stringFormat ?? (_stringFormat = string.Format("{0} assigned you to card '{1}'.",
