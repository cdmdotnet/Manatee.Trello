/***************************************************************************************
	...
	File Name:		AddedToOrganizationNotification.cs
	Namespace:		Manatee.Trello
	Class Name:		AddedToOrganizationNotification
...
{
	/// <summary>
	/// Provides notification that the current member was added to an organization.
	/// </summary>
	public class AddedToOrganizationNotification : Notification
	{
		...
		/// <summary>
		/// Creates a new instance of the AddedToOrganizationNotification class.
		/// </summary>
		/// <param name="notification">The base notification</param>
		public AddedToOrganizationNotification(Notification notification)
