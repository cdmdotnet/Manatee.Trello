...
namespace Manatee.Trello
{
	...
	public class AttachmentCollection : ReadOnlyAttachmentCollection, IAttachmentCollection
	{
		...
		public async Task<IAttachment> Add(string url, string name = null)
		{
			...
			var newData = await JsonRepository.Execute<IJsonAttachment>(Auth, endpoint, parameters);
		...
		/// <returns>The attachment generated by Trello.</returns>
		public async Task<IAttachment> Add(byte[] data, string name)
		{
