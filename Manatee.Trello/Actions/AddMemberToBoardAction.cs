/***************************************************************************************
	...
	File Name:		AddMemberToBoardAction.cs
	Namespace:		Manatee.Trello
	Class Name:		AddMemberToBoardAction
...
namespace Manatee.Trello
{
	...
	public class AddMemberToBoardAction : Action
	{
		...
		/// <summary>
		/// Creates a new instance of the AddMemberToBoardAction class.
		/// </summary>
		...
		{
			return _stringFormat ?? (_stringFormat = string.Format("{0} added {1} to board '{2}' on {3}",
