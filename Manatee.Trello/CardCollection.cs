...
namespace Manatee.Trello
{
	...
	public class CardCollection : ReadOnlyCardCollection
	{
		...
		public virtual Card Add(string name, string description = null, Position position = null, DateTime? dueDate = null,
		...
		/// <returns>The <see cref="Card"/> generated by Trello.</returns>
		public virtual Card Add(Card source)
		{
		...
		/// <returns></returns>
		public virtual Card Add(string name, string sourceUrl)
		{
			var error = NotNullOrWhiteSpaceRule.Instance.Validate(null, name);
			if (error != null)
				throw new ValidationException<string>(name, new[] { error });
