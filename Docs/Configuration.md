...
- `Serializer`/`Deserializer` allows you to provide your own JSON serializer.  For more information, please see the [JSON serialier page](Supplying-your-own-JSON-serializer-3).  The built-in implementation uses [Manatee.Json](https://github.com/gregsdennis/Manatee.Json)
- `RestClientProvider` allows you to provide your own HTTP client.  For more information, please see the [REST provider page](Supplying-your-own-ReST-client-3).  The built-in implementation uses ASP.Net's `WebClient`.
